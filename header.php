  <div id="header" class="page-header"  style="background-color: #accffe;">
            <div class="navbar navbar-expand-lg">
                ...
                <a href="index.html" class="navbar-brand d-lg-none">
                    ...
                    <!-- <img src="../assets/img/logo.png" alt="..."> --><span class="hidden-folded d-inline l-s-n-1x d-lg-none">Lk</span> </a>
                <!-- / brand -->
                <!-- Navbar collapse -->
                            ...
                            <div class="setting px-3">
                                ...
                                <div class="mb-2">
                                    <label class="radio radio-inline ui-check ui-check-md">
                                        <input type="radio" name="bg" value="bg-blue"> <i></i></label>
