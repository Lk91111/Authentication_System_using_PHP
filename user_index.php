                            ...
                            <div class="p-3">
                                <div class="d-flex">
                                    <ul class="nav nav-pills">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#" data-toggle="tab" data-target="#tab_2">update profile</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#" data-toggle="tab" data-target="#tab_3">delete profile</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show" id="tab_2">
                                        <div class="card" style="height:auto;">
                                            ...
                                            <div class="card-body">
                                                <form method="post" action="up_2.php">
                                    ...
                                    <div class="tab-pane fade show" id="tab_3">
                                        <div class="card" style="height:auto;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <br><a class="col-lg-6" style="color:red;border: solid 1px #ff9b9b;padding:5px 5px 7px 7px; border-radius: 5px;background-color:rgba(255,155,155,.3);" href="delete_1.php?id=<?=$row['id']?>">Delete</a><a class="col-lg-6" style="color:green;border: solid 1px #6aff6a;padding:5px 5px 7px 7px; border-radius: 5px;background-color:rgba(106,255,106,.3);margin-left:15px" href="">Cancel</a>
                                            </div>
